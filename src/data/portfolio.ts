...
export const portfolio: PortfolioData = {
  personal: {
    ...
    tagline: "Mobile and web systems with real APIs and databases.",
    bio: "Fourth-year Information Technology student — shipping workflows across React Native, Laravel, and PostgreSQL.",
    location: "Lipa City, Philippines",
    status: "Open to internship · 2026",
    availability: "Open to internship opportunities in 2026",
    focusAreas: [
      "Mobile development",
      "Web development",
      "Full-stack systems",
  ...
  projects: [
    {
      ...
      architecture: [
        ...
        { label: "Campus validation workflow" },
      ],
